...
const LANG = {
  ...
  fr: {
    ...
    hero_badge:"Spécialiste Cybersécurité & Systèmes Embarqués",
    hero_name_1:"Abderrahmen", hero_name_2:"Ben Omrane",
    hero_subtitle:"Analyste Sécurité · Red & Blue Team · Sécurité IoT · IA",
    hero_desc:"Spécialiste en cybersécurité avec plus de 2 ans d'expérience en sécurité des systèmes d'information. Spécialisé en détection de menaces, réponse aux incidents, tests d'intrusion, durcissement IoT et solutions de sécurité basées sur l'IA.",
    ...
    about_p1:"Spécialiste en cybersécurité de 25 ans avec un double profil unique en Électronique & Systèmes Embarqués (Licence) et Sécurité des Systèmes d'Information (Master). Cette combinaison rare me permet de comprendre en profondeur les surfaces d'attaque matérielles et logicielles.",
    ...
    about_p3:"Au-delà de la sécurité pure, je suis passionné par les applications IA/ML en cybersécurité, l'analyse de malwares et le domaine en pleine évolution de la sécurité des systèmes embarqués.",
    ...
    exp1_b1:"Assistance technique en sécurité lors des phases de pré-intégration et de post-déploiement.",
    exp1_b2:"Analyse et résolution des incidents techniques de sécurité après mise en production.",
    exp1_b3:"Coordination avec les éditeurs de logiciels pour l'identification des vulnérabilités, la gestion des correctifs critiques et l'amélioration de la posture de sécurité.",
    exp1_b4:"Support technique, fonctionnel et sécurité en phase de pré-intégration.",
    exp2_role:"Analyste Cybersécurité", exp2_co:"Keystone Group", exp2_date:"Fév 2024 – Nov 2025",
    exp2_b1:"Intégration de Threat Intelligence dans les plateformes clients pour renforcer les capacités de détection.",
    exp2_b2:"Participation aux investigations de sécurité numérique et à l'analyse des incidents.",
    exp2_b3:"Déploiement et configuration de solutions de sécurité pour des environnements d'entreprise.",
    exp2_b4:"Participation aux missions de tests d'intrusion au sein de l'équipe Red Team pour améliorer les règles de détection SIEM.",
    exp3_role:"Analyste SOC — Niveau 2/3", exp3_co:"Keystone Group", exp3_date:"Fév 2024 – Nov 2025",
    exp3_b1:"Traitement des incidents de sécurité de niveaux 2/3 (identification, analyse, remédiation) via des plateformes SIEM.",
    exp3_b2:"Communication des alertes et recommandations de sécurité aux clients.",
    ...
    edu1_desc:"Études approfondies en cybersécurité, sécurité réseau, architectures sécurisées, tests d'intrusion et forensique numérique. Projet de fin d'études : Module de création de laboratoires pour Cyber-Range.",
    ...
    contact_desc:"Que ce soit pour un projet sécurité, une opportunité de collaboration, ou simplement une conversation sur la cybersécurité et les systèmes embarqués — je suis toujours disponible.",
    contact_phone:"Téléphone", form_name:"Nom", form_email:"Email", form_msg:"Message", form_send:"Envoyer →",
    copy:"Copier", copied:"Copié !"
  },

  de: {
    nav_about:"Über mich", nav_skills:"Kenntnisse", nav_exp:"Erfahrung", nav_edu:"Studium",
    nav_projects:"Projekte", nav_certs:"Zertif.", nav_roadmap:"Roadmap",
    nav_blog:"Blog", nav_contact:"Kontakt",

    hero_badge:"Cybersecurity-Spezialist & Embedded Systems Engineer",
    hero_name_1:"Abderrahmen", hero_name_2:"Ben Omrane",
    hero_subtitle:"Security Analyst · Red & Blue Team · IoT Security · KI",
    hero_desc:"Ein motivierter Cybersecurity-Spezialist mit über 2 Jahren Erfahrung in der Informationssicherheit. Spezialisiert auf Bedrohungserkennung, Incident Response, Penetrationstests, IoT-Sicherheitshärtung und KI-gestützte Sicherheitslösungen.",
    ...
    hero_card_role:"Technical Consultant @ Naxxum Africa",
    hero_btn_contact:"Kontakt →", hero_btn_cv:"Lebenslauf ↓", hero_btn_projects:"Projekte ansehen",
    hero_stat_exp:"Jahre XP", hero_stat_certs:"Zertif.", hero_stat_proj:"Projekte", hero_stat_lang:"Sprachen",

    domain_cyber:"Cybersecurity", domain_embedded:"Embedded Systems", domain_ai:"KI & Machine Learning",
    domain_cyber_desc:"Red Team · Blue Team · Audit · Incident Response · SIEM",
    domain_embedded_desc:"Mikrocontroller · IoT · UART · GSM · XBee · Hardware-Sicherheit",
    domain_ai_desc:"Machine Learning · KI in CyberSec · Anomalieerkennung",

    about_eyebrow:"Wer ich bin", about_title:"Über <span>Mich</span>",
    about_p1:"25-jähriger Cybersecurity-Spezialist mit einzigartigem dualem Hintergrund in Elektronik & Embedded Systems (BSc) und Informationssystemsicherheit (MSc). Diese seltene Kombination ermöglicht mir ein tiefes Verständnis beider Angriffsflächen — Hardware und Software.",
    about_p2:"Mein Berufsweg umfasst SOC-Operationen, Penetrationstests, Threat Intelligence und IoT-Sicherheitshärtung. Erfahrung in Incident Response, SIEM-Management und Deployment von Sicherheitslösungen für Unternehmensumgebungen.",
    about_p3:"Ich bin leidenschaftlich für KI/ML-Anwendungen in der Cybersecurity, Malware-Analyse und das sich schnell entwickelnde Feld der Embedded Systems Security.",
    ...
    skills_eyebrow:"Womit ich arbeite", skills_title:"Technische <span>Kenntnisse</span>",
    tab_all:"Alle", tab_cyber:"Cybersecurity", tab_embedded:"Embedded", tab_ai:"KI",

    exp_eyebrow:"Karriereweg", exp_title:"Berufliche <span>Erfahrung</span>",
    exp1_role:"Technical Consultant", exp1_co:"Naxxum Africa", exp1_date:"Nov 2025 – heute",
    exp1_b1:"Technischer Sicherheitssupport in Pre-Integrations- und Post-Deployment-Phasen.",
    exp1_b2:"Analyse und Behebung technischer Sicherheitsvorfälle nach Produktivsetzungen.",
    exp1_b3:"Koordination mit Softwareherstellern zur Schwachstellenidentifikation, zum Patch-Management und zur Verbesserung der Sicherheitslage.",
    exp1_b4:"Technische, funktionale und sicherheitsbezogene Beratung in der Pre-Integrations-Phase.",
    exp2_role:"Cybersecurity Analyst", exp2_co:"Keystone Group", exp2_date:"Feb 2024 – Nov 2025",
    exp2_b1:"Integration von Threat Intelligence in Kundenplattformen zur Verbesserung der Erkennungsfähigkeiten.",
    exp2_b2:"Mitwirkung bei Untersuchungen zur digitalen Sicherheit und bei der Analyse von Sicherheitsvorfällen.",
    exp2_b3:"Bereitstellung und Konfiguration von Sicherheitslösungen für Unternehmensumgebungen.",
    exp2_b4:"Teilnahme an Penetrationstests im Red Team zur Verbesserung der SIEM-Erkennungsregeln.",
    exp3_role:"SOC Analyst — Stufe 2/3", exp3_co:"Keystone Group", exp3_date:"Feb 2024 – Nov 2025",
    exp3_b1:"Bearbeitung von Sicherheitsvorfällen der Stufen 2/3 über SIEM-Plattformen (Identifizierung, Analyse, Behebung).",
    exp3_b2:"Kommunikation von Alarmstatus und Sicherheitsempfehlungen an Kunden.",
    exp3_b3:"Kategorisierung von Cyberangriffen und Beitrag zur Eindämmung von Bedrohungen.",

    edu_eyebrow:"Akademischer Hintergrund", edu_title:"<span>Studium</span>",
    edu1_deg:"Masterstudium (Professionell)", edu1_field:"Sicherheit von Informationssystemen und Infrastrukturen",
    edu1_school:"Höheres Institut für Informatik El Manar", edu1_date:"Sep 2023 – Jul 2025 · Ariana, Tunesien",
    edu1_desc:"Vertieftes Studium in Cybersecurity, Netzwerksicherheit, sicheren Architekturen, Penetrationstests und Digital Forensics. Abschlussprojekt: Entwicklung eines Cyber-Range-Labormoduls.",
    edu2_deg:"Bachelorstudium", edu2_field:"Elektronik, Elektrotechnik & Automatisierung — Embedded Systems",
    edu2_school:"Höheres Institut für Informatik El Manar", edu2_date:"Sep 2020 – Jun 2023 · Ariana, Tunesien",
    edu2_desc:"Schwerpunkt auf Embedded Systems, Mikrocontroller, Kommunikationsprotokolle (UART, GSM, XBee), IoT-Entwicklung und Echtzeitsysteme. Abschlussprojekt: ATmega328P-basierter IoT-Bewässerungsknoten.",

    proj_eyebrow:"Was ich gebaut habe", proj_title:"<span>Projekte</span>",
    proj_tab_all:"Alle", proj_tab_cyber:"Cybersecurity", proj_tab_embedded:"Embedded", proj_tab_ai:"KI",

    certs_eyebrow:"Meine Zertifizierungen", certs_title:"<span>Zertifizierungen</span>",
    cert_tab_all:"Alle", cert_tab_cyber:"Cybersecurity", cert_tab_embedded:"Embedded", cert_tab_ai:"KI",
    ...
    assoc_eyebrow:"Vereinsengagement", assoc_title:"Vereins-<span>Erfahrung</span>",
    assoc_org:"Enactus ISI", assoc_role:"Mitglied · 4 Jahre | VP Finanzen · 1 Jahr | Brainstorming-Leiter · 2 Jahre",
    assoc_desc:"Aktives Mitglied von Enactus ISI für 4 Jahre. Als Vizepräsident für Finanzen und Brainstorming-Leiter entwickelte ich starke Führungskompetenz, Finanzplanung und kreative Problemlösungsfähigkeiten — als Ergänzung zu meinem technischen Profil.",
    ...
    contact_desc:"Ob Sicherheitsprojekt, Zusammenarbeit oder einfach ein Gespräch über Cybersecurity und Embedded Systems — ich freue mich immer auf Kontakt.",
